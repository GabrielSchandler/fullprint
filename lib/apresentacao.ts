...
export const PACOTES: Pacote[] = [
  ...
  },
  {
    ...
    resumo: "O site institucional, a marca redesenhada e a presença aberta nos marketplaces.",
    implantacao: 5000,
    mensalidade: 400,
...
export const COMPARATIVO: { recurso: string; valores: ValorComparativo[] }[] = [
  ...
  { recurso: "Site institucional", valores: [null, null, true] },
  { recurso: "Identidade visual", valores: [null, null, true] },
  { recurso: "Google Meu Negócio", valores: [null, null, true] },
